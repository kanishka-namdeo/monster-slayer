...
const TRACKS: Record<string, Track> = {
  ...
  // ---- Fangtooth Pass ----
  mountain: T({
    bpm: 116, loop: true, p1Duty: 0.25, p2Duty: 0.125,
    p1:
      'G4:1,C5:1.5,B4:0.5,C5:1,D#5:1,D5:1,' +
      'D#5:1,D5:1,C5:2,' +
      'F4:1,G4:1,G#4:1.5,G4:0.5,' +
      'G4:1,F4:1,D#4:2,' +
      'C5:1.5,D5:0.5,D#5:1,G5:1,' +
      'G5:1,F5:1,D#5:1,D5:1,' +
      'D#5:0.5,F5:0.5,G5:0.5,F5:0.5,D#5:1,D5:1,' +
      'C5:3,R:1',
    p2:
      'C4:2,D#4:2,G3:2,C4:2,D#3:2,G3:2,F3:2,C4:2,' +
      'C4:2,D#4:2,G3:2,C4:2,D#3:2,G3:2,F3:2,C4:2',
    bass:
      'C3:2,G2:2,G2:2,C3:2,D#3:2,G2:2,F2:2,C3:2,' +
      'C3:2,G2:2,G2:2,C3:2,D#3:2,G2:2,F2:2,C3:2',
    drums: 'K.H.S.H.K.H.S.H.',
  }),
  ...
  // ---- Kaer Serpen ruins ----
  ruins: T({
    bpm: 72, loop: true, p1Duty: 0.25, p2Duty: 0.125,
    p1:
      'A4:1.5,B4:0.5,C5:2,B4:1,A4:1,E4:2,' +
      'F4:1.5,G4:0.5,A4:2,G4:2v,E4:2,' +
      'A4:1.5,B4:0.5,C5:2,D5:1,C5:1,B4:2,' +
      'C5:1,B4:1,A4:1,G4:1,A4:3v,R:1',
    p2: 'A3:4,E3:4,F3:4,E3:4,A3:4,D3:4,E3:4,A3:4',
    bass: 'A2:4,E2:4,F2:4,E2:4,A2:4,D2:4,E2:4,A2:4',
  }),
};
