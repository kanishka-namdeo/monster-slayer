...
<img src="docs/media/og-banner.png" alt="Monster Slayer — Green Edition" width="820">
...
![Trailer](docs/media/trailer.gif)
...
| ⚔️ **Pokémon-style battles** | Turn-based combat with **two swords** (steel for beasts of flesh, silver for monsters — +25% with the right blade), **speed-based initiative** (fast monsters strike first; Cat-school witchers outrun wolves), **real status effects** (Aard stagger, Axii hex, poison, toxicity, root-stun that costs you a turn), crits, boss AI, and five monster classes with their own oils |
| 🔥 **4 witcher Signs** | IGNI (fire — x1.5 vs cursed, x1.3 vs insectoids), AARD (telekinetic shock + stagger), QUEN (damage shield with on-screen ward), AXII (hex) — fueled by stamina, discounted by school |
...
| 🎞️ **GB-feel animation pass** | Hand-dithered terrain with per-tile variants, water shores & foam, swaying flowers/reeds, bubbling cauldron, candle-flicker shrine, crawling thorns, hearth fire with rising sparks, NPC glide-walk with step-bob, reeds rustle, dialog slide-open, encounter flash + ink fades, pixel-perfect integer-scaled canvas |
| ⚡ **Battle juice** | Gen-1-sequenced combat feedback: HP bars drain and monsters faint **when the damage line lands**, attack lunges with anticipation-recovery arcs on *both* sides, impact blinks and knockback shake, slash streaks, IGNI palette-invert flicker with chunky fire particles, QUEN ward brackets, orbiting AXII hex, potion sparkles, blade-oil glint, scrolling item menu with the cursor always in view, status HUD (STN/HEX/UP · QUN/PSN/TOX/FUR/WEK), player slide-in on a platform ledge, and a proper GAME OVER screen where the beast that felled you looms over the fallen witcher |
...
| Title | The world |
|---|---|
| ![Title](docs/media/screenshots/01-title.png) | ![Village](docs/media/screenshots/03-village.png) |
| *The title screen.* | *Hollow Creek, the village hub.* |

| Contracts | Alchemy |
|---|---|
| ![Board](docs/media/screenshots/04-board.png) | ![Shop](docs/media/screenshots/06-shop.png) |
| *The notice board pays in crowns.* | *Mira's hut: potions, oils, salves.* |

| Turn-based combat | Signs |
|---|---|
| ![Battle menu](docs/media/screenshots/11-battle-menu.png) | ![Signs](docs/media/screenshots/12-battle-signs.png) |
| *Steel or silver — choose the right blade.* | *Four Signs fueled by stamina.* |

| IGNI! | The final boss |
|---|---|
| ![Igni](docs/media/screenshots/13-battle-igni.png) | ![Leshen](docs/media/screenshots/14-boss-leshen.png) |
| *A torrent of flame — curses burn.* | *The Leshen of Oldewood.* |

| A moral choice | The dark places |
|---|---|
| ![Choice](docs/media/screenshots/05-elder-choice.png) | ![Graveyard](docs/media/screenshots/16-graveyard.png) |
...
| Desktop | Mobile |
|---|---|
| ![Desktop](docs/media/screenshots/17-device-desktop.png) | ![Mobile](docs/media/screenshots/18-device-mobile.png) |
...
| [`battle.ts`](src/game/battle.ts) | 1,023 | Turn-based combat: initiative & turn order, sword tiers, oils, signs, Quen, toxicity, poison, root-stun, boss AI + msg-gated battle juice (lunge arcs, flash flicker, faints, wards, bars) + pointer menus |
...
| [`data.ts`](src/game/data.ts) | 426 | Monsters (with spd), signs, items, schools, shops, quests |
